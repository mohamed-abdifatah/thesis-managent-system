        ...
        <div class="header-right ms-auto">
            <div class="d-flex align-items-center gap-2">
                <div class="dropdown nxl-h-item d-none d-md-flex">
                    <button type="button" class="ta-head-btn" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                        <i class="feather-menu"></i>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end ta-notification-menu ta-head-dropdown">
                ...
                <div class="dropdown nxl-h-item">
                    <button type="button" class="ta-head-btn position-relative" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                ...
                <div class="nxl-h-item d-none d-sm-flex">
                    <div class="full-screen-switcher">
                        <button type="button" class="ta-head-btn ta-fullscreen-btn" onclick="toggleFullScreen(document.body)" aria-label="Toggle fullscreen">
                ...
                <div class="dropdown nxl-h-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown ta-head-dropdown">
