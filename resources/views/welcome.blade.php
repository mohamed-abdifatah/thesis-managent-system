        ...
        <style>
            ...
            * {
            ...
            body {
                ...
                color: var(--ink);
                background: radial-gradient(circle at 20% 10%, #fff3e6 0%, transparent 55%),
                    radial-gradient(circle at 80% 20%, #d7f3f6 0%, transparent 40%),
                    linear-gradient(120deg, #fdf9f4 0%, #f5efe8 100%);
                min-height: 100vh;
            }
