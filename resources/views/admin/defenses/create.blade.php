<x-app-layout>
    <div class="page-header d-flex align-items-center justify-content-between mb-4">
        <div>
            <h2 class="page-header-title h3 mb-0">Create Defense Session</h2>
                ...
                <div class="card stretch stretch-full border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="location" name="location" value="{{ old('location') }}" placeholder="Room 201, Main Hall">
                        </div>
                    ...
                    <div class="card-body">
                            ...
                            <table class="table table-hover align-middle" id="committeeTable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <button type="button" class="btn btn-sm btn-outline-danger remove-committee" disabled>
                        ...
                        <div class="d-flex align-items-center justify-content-end gap-3 mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="feather-check-circle me-1"></i> Create Session
                            </button>
                        </div>
                    </div>
                </div>
