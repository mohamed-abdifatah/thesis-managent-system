<x-app-layout>
    ...
    <div class="page-header d-flex align-items-center justify-content-between mb-4">
        <div>
            <h2 class="page-header-title h3 mb-0">Create User</h2>
            ...
            <div class="card stretch stretch-full border-0 shadow-sm">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p class="text-muted small">Enter the details below to create a new system user account.</p>
                    </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control-lg @error('name') is-invalid @enderror" 
                                       id="name" name="name" value="{{ old('name') }}" required autofocus placeholder="e.g. John Doe">
                                @error('name')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" 
                                       id="email" name="email" value="{{ old('email') }}" required placeholder="e.g. john@example.com">
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 d-none transition-all" id="supervisor-field">
                                <div class="p-4 rounded-3 border border-1 border-primary bg-primary-subtle bg-opacity-10">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <label for="supervisor_id" class="form-label mb-0 fw-bold text-primary">Assign Initial Supervisor</label>
                                    </div>
                                    <p class="small text-muted mb-3">Optional: Automatically link this student to a supervisor.</p>
                            ...
                            <div class="col-12 mt-4 mb-2">
                                <h6 class="fw-bold text-dark border-bottom pb-2">Security</h6>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="password" class="form-control form-control-lg @error('password') is-invalid @enderror" 
                                       id="password" name="password" required autocomplete="new-password" placeholder="••••••••">
                                @error('password')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
